...
interface OrderWithProducts extends QuickOrder {
            ...
            <Page size="A4" style={{ padding: "50px" }}>
                ...
                >
                    <View style={{ display: "flex", flexDirection: "column" }}>
                        <Text style={{ fontWeight: "bold", fontSize: "16px" }}>{order.name}</Text>
                        <Text style={{ fontSize: "12px", color: "#6b7280" }}>{order.address}</Text>
                    </View>
                ...
                <View>
                    ...
                    >
                        <Text style={{ fontWeight: "semibold", fontSize: "12px", width: "40%" }}>{order?.product?.name?.slice(0, 30)}</Text>
                        <Text style={{ fontWeight: "semibold", fontSize: "12px", width: "20%" }}>{order.quantity}</Text>
                        <Text style={{ fontWeight: "semibold", fontSize: "12px", width: "20%" }}>{order.total}</Text>
                    </View>
                </View>
                <View
                    style={{
