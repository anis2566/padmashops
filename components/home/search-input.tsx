...
export const SearchInput = () => {
    ...
    return (
        <Form {...form}>
            <div className="mt-3 mx-3 block md:hidden">
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full border border-primary p-1 relative rounded-md relative">
                    <FormField
